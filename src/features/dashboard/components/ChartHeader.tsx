export default function ChartHeader() {
    return (
        <div className="flex w-full items-center justify-between p-4 border-b border-border bg-bg/50">
            ...
            <button className="flex items-center gap-2 px-3 py-1.5 bg-primary text-white hover:opacity-90 rounded-lg text-sm font-medium transition-all active:scale-95">
