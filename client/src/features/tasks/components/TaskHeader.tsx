...
export function TaskHeader({ currentFilter, onFilter }: TaskHeaderProps) {
    return (
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div>
                <h1 className="text-2xl font-bold text-text-main">All Tasks</h1>
                <p className="text-sm text-text-muted">Manage and organize your project goals.</p>
            </div>
